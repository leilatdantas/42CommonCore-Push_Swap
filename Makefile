...
#    Updated: 2023/10/02 11:49:54 by lebarbos         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
#FILES
NAME			= so_long
SRC_FILES		= init utils valid_map endgame so_long moves main
OBJS			= $(SRC_FILES:%=%.o)
TARGET			= $(addprefix $(OBJ_PATH)/, $(OBJS))
#BONUS
NAME_BONUS		= so_long_bonus
SRC_FILES_BONUS = init utils valid_map endgame so_long moves
